...
public class PostMortemGamerules {
    ...
    public static final GameRules.Key<GameRules.IntegerValue> DEFAULT_BLEEDING_APPLICATION = GameRules.register("defaulBleedingApplication", GameRules.Category.PLAYER, GameRules.IntegerValue.create(1));
