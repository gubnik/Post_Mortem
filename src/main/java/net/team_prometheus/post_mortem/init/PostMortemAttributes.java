...
public class PostMortemAttributes {
    ...
    public static final RegistryObject<Attribute> BLEED_APPLICATION = ATTRIBUTES.register("bleed_application", () -> new RangedAttribute("attribute.name.generic.bleed_application", 0.0D, 0.0D, 1.0D));
}
